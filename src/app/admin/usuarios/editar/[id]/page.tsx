...
export default function EditarUsuarioPage() {
  ...
  const [form, setForm] = useState({
    nombre: "",
    correo: "",
    contraseña: "", // <- aquí guardamos la nueva contraseña si la ponen
  });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      ...
      <div className="w-full max-w-2xl bg-white shadow-2xl rounded-2xl p-10 border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            className="bg-blue-600 text-white py-3 rounded-xl text-lg font-semibold hover:bg-blue-700 transition w-full shadow-md"
          >
            Guardar Cambios
          </button>
