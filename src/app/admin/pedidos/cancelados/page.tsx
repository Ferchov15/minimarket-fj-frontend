...
export default function PedidosCancelados() {
    ...
    const fetchPedidos = async () => {
        try {
            ...
            const filtrados = data.filter((p: any) => p.estado === "Cancelado");
        ...
        <div className="min-h-screen bg-gray-200 text-black p-6">
            <main className="flex flex-col items-center">
                ...
                {pedidos.length === 0 ? (
                    ...
                    <table className="border border-black bg-red-500 text-center w-full md:w-3/4 rounded-lg overflow-hidden shadow">
                        <thead>
